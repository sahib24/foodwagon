...
export default function Navbar() {
  return (
    <div className="custom-container text-center md:text-left py-4">
      <div className="py-3 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto justify-center md:justify-end">
          ...
          <button className="flex items-center gap-2 cursor-pointer bg-white text-[#FFB30E] py-2 px-4 shadow-lg shadow-[#ffb30e6a] font-bold">
            <Image
