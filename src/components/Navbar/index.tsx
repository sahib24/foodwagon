        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto justify-center md:justify-end relative">
          <div
            className={`transition-all duration-500 transform ${
              showSearch
                ? "opacity-100 translate-x-0 max-w-[300px]"
          ...
          >
            <input
              ...
              className="pl-4 pr-20 py-2.5 rounded border border-[#ffb30e6a] text-sm placeholder:text-gray-400 w-full"
            />

            <button
              onClick={handleSearchToggle}
              className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] hover:text-orange-500 transition font-bold cursor-pointer"
            >
              Search Food
            </button>
          </div>
          ...
          {!showSearch && (
            <button
              onClick={handleSearchToggle}
              className="flex items-center gap-1 text-[10px] hover:text-orange-500 transition font-bold cursor-pointer"
            >
              <Image
          ...
          <button className="flex items-center text-[12px] gap-1 bg-white text-[#FFB30E] hover:text-black py-2 px-3.5 shadow-md font-bold rounded-md">
            <Image
