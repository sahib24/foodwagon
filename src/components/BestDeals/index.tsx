...
const FoodCards = () => {
  return (
    <div className="custom-container px-4 sm:px-6 lg:px-0 py-10 space-y-10">
      <div className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col lg:flex-row h-auto lg:h-[420px]">
        <div className="w-full lg:w-1/3 p-6 lg:p-10 flex flex-col justify-center">
          ...
          <button className="bg-gradient-to-r from-yellow-400 mb-6 cursor-pointer to-orange-400 text-white font-semibold px-6 py-2 rounded hover:scale-105 transition">
            PROCEED TO ORDER
          </button>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col lg:flex-row-reverse h-auto lg:h-[420px]">
        <div className="w-full lg:w-1/3 p-6 lg:p-10 flex flex-col justify-center">
          <h3 className="text-2xl lg:text-3xl font-bold mb-4 text-gray-800 leading-snug">
      ...
      <div className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col lg:flex-row h-auto lg:h-[420px]">
        <div className="w-full lg:w-1/3 p-6 lg:p-10 flex flex-col justify-center">
          ...
          <button className="bg-gradient-to-r from-yellow-400 mb-6 to-orange-400 cursor-pointer text-white font-semibold px-6 py-2 rounded hover:scale-105 transition">
            PROCEED TO ORDER
          </button>
        </div>
        <div className="relative w-full lg:w-2/3 h-64 lg:h-full">
