...
export default function InstallAppSection() {
  return (
    <div className="lg:bg-[url('/install.png')] bg-[url('/install1.png')] bg-cover bg-center w-full h-[500px] mb-8">
      <div className="flex items-center justify-center lg:justify-end lg:pr-20 h-full">
        <div className="text-center md:text-left p-4 md:p-12">
          ...
          <p className="text-gray-700 text-base md:text-lg mb-6 md:w-[400px]">
